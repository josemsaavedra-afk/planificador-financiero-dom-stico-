...
-- Ajustada al esquema real auditado el 2026-09-19.
...
with check (
  ...
  and exists (
    ...
    where a.id = account_id
      and a.household_id = household_id
  )
);
...
with check (
  ...
  and exists (
    ...
    join public.movement_series m on m.id = movement_series_id
    where l.id = statement_line_id
